...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dout, grads['W3'], grads['b3'], = affine_backward(dout, cache3)    # first backward pass
